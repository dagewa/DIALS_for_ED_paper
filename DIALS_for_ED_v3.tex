...
reported in \citeasnoun{Clabbers2017}. These datasets are available online
at \url{https://dx.doi.org/10.5281/zenodo.1250447}.
...
distance is set by the projector lens system and does not correspond directly to a
...
see \citeasnoun{Waterman2016}. The flexible geometry description and refinement
...
\end{tabular}
\fntext[1]{Individual \emph{datasets 1--7} were truncated at $CC_{{1}/{2}} \geq 50\%$ and
$\langle I/\sigma(I) \rangle \geq 1.0$ \cite{Diederichs2013};
the merged dataset was limited to $\SI{2.1}{\angstrom}$ based on the model
refinement results.}
