...
rotations can be represented precisely.
...
\MC{We can add an image of one 1k frame with the correct description and
correct geometric positions of each segment as defined in the import plugin for
the Timepix cbf’s}
\DW{It might be useful to combine such an image with a zoomed region duplicated
with two different sets of spot-finding settings (see text below)}
