...
diffraction geometry. The short wavelength of an electron beam (0.02508 \AA{}
for 200 keV electrons compared to 1.0332 \AA\ for 12 keV X-rays) \TG{changed
...
(see Figure \DW{see below}).  If indexing is successful, it is likely to work
