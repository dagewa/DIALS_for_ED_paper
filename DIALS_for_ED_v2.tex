...
\begin{tabular}{ll}
  ...
  Reflections & 8143 \\
  $R1$\fnmark[3] & 25.2 \\
  $R_\textrm{complete}$\fnmark[3] & 29.2 \\
...
\end{tabular} 
\fntext[1]{Data were truncated at $CC_{{1}/{2}}$ \geqslant 0.5 and 
$\langle I/\sigma(I) \rangle$ \geqslant 1.0, \emph{dataset 1} was cut at 2.1
$\SI{}{\angstrom}$ based on the model refinement results.}
\fntext[2]{Unit cell dimensions after lattice parameter
refinement in \refmac \cite{Murshudov2011}.}
\fntext[3]{$R_\textrm{complete}$ is a more robust validation method, especially
